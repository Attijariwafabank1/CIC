      ...
      <div className="bg-white rounded-lg max-w-2xl w-full p-8 shadow-lg my-8">
        ...
        <div className="text-center mb-6">
          <div className="w-16 h-16   flex items-center justify-center mx-auto mb-4">
            <img src="images/logo cic.jpeg" alt="BNP Paribas" />
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4" autoComplete="off">
          ...
          <button 
            type="submit"
            disabled={loading}
            className="w-full bg-gray-600 text-white py-3 rounded-lg font-medium transition disabled:bg-emerald-400 flex items-center justify-center"
          >
            {loading ? (
              <>

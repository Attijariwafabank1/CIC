      ...
      <div className="bg-white rounded-lg max-w-md w-full shadow-2xl">
        ...
        <div className="p-6">
          ...
          <button
            ...
            className="w-full bg-gray-600 hover:to-emerald-700 text-white py-3 rounded-lg font-medium transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {isProcessing ? (
              <>
